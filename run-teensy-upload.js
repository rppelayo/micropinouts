...
async function runTeensyUpload() {
  console.log('🚀 Starting Teensy FZPZ Upload to Database...\n');
  
  try {
    const fetcher = new TeensyFetcher();
    await fetcher.run();
...
if (require.main === module) {
  runTeensyUpload().catch(console.error);
}

module.exports = runTeensyUpload;
